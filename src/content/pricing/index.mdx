...
pricing_card:
  - title: Trial
    ...
    buttons:
      buy_now:
        label: Hubungi Kami
        link: "https://wa.me/+6285176929958"
      free_trial:
        link: "#"
    services:
  ...
  - title: Medium
    pre_currency: Rp
    post_currency:
    price: 30,000 / Karyawan
    icon: table #icon package react-feather-icon [https://feathericons.com/]
    description: Nikmati discount untuk perushaan dibawah 20 karyawan dengan hanya membayar Rp 30,000 / Keryawan.
    featured: true
    buttons:
      buy_now:
        label: Hubungi Kami
